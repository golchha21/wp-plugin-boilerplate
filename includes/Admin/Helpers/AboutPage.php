...
final class AboutPage
{
    public static function render(string $version): void
    {
        ...
        <p>Designed to be copied, renamed, and adapted, this framework removes the repetitive and error-prone parts of building WordPress settings while staying close to core APIs.</p>
